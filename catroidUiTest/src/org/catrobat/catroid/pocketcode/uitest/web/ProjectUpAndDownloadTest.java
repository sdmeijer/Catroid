 ...
 */
package org.catrobat.catroid.pocketcode.uitest.web;
...
public class ProjectUpAndDownloadTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	private static final int LONG_TEST_SOUND = org.catrobat.catroid.pocketcode.uitest.R.raw.longsound;
	...
	private void downloadProjectAndReplace(String projectName) {
		...
		solo.goBack();
		launchActivityWithIntent("org.catrobat.catroid.pocketcode", MainMenuActivity.class, intent);
		solo.sleep(500);
