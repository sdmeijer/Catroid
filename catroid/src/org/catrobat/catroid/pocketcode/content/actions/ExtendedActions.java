...
import org.catrobat.catroid.pocketcode.content.BroadcastEvent.BroadcastType;
...
public class ExtendedActions extends Actions {
	...
	public static LegoNxtMotorActionAction legoNxtMotorAction(Sprite sprite, String motor,
			org.catrobat.catroid.pocketcode.content.bricks.LegoNxtMotorActionBrick.Motor motorEnum, Formula speed) {
	...
	public static LegoNxtMotorStopAction legoNxtMotorStop(
			org.catrobat.catroid.pocketcode.content.bricks.LegoNxtMotorStopBrick.Motor motorEnum) {
	...
	public static LegoNxtMotorTurnAngleAction legoNxtMotorTurnAngle(Sprite sprite,
			org.catrobat.catroid.pocketcode.content.bricks.LegoNxtMotorTurnAngleBrick.Motor motorEnum, Formula degrees) {
